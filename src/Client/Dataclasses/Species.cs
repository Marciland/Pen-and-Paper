    ...
    public class Species
    {
        ...
        public static List<Species> GetSpecies()
        {
            return new List<Species>
            {
                ...
                new(){ Type = 1, Name = "Elf",     Ap = 18, Le = 2, Sk = -4, Zk = -6, Gs = 8, Attributes = "IN und GE +1, KL oder KK -2",   Perks = new List<PerkFlaw> { PerkFlaw.GetPerk("Zauberer"), PerkFlaw.GetPerk("Zweistimmiger Gesang") } },
